...
class ContactoModelo {
  ...
  factory ContactoModelo.fromJson(Map<String, dynamic> json) => ContactoModelo(
      ...
      latitud: double.parse(
          double.parse(json["latitud"].toString()).toStringAsFixed(7)),
      longitud: double.parse(
          double.parse(json["longitud"].toString()).toStringAsFixed(7)),
      ...
      fotoReferenciaFecha: Textos.parseoDateFire(json["foto_referencia_fecha"]),
  ...
  Map<String, dynamic> toFirestore() => {
        ...
        "domicilio": domicilio,
        "fecha_domicilio":
            fechaDomicilio == null ? null : Timestamp.fromDate(fechaDomicilio!),
        "numero": numero,
        "numero_fecha":
            numeroFecha == null ? null : Timestamp.fromDate(numeroFecha!),
        ...
        "foto": foto,
        "foto_fecha": fotoFecha == null ? null : Timestamp.fromDate(fotoFecha!),
        ...
        "modificado":
            modificado == null ? null : Timestamp.fromDate(modificado!)
      };
