...
ContactoModelo(
  ...
  factory ContactoModelo.fromJson(Map<String, dynamic> json) => ContactoModelo(
    ...
    empleadoFotoReferencia: json["empleado_foto_referencia"],
    fotoReferenciaFecha:
        DateTime.tryParse(json["foto_referencia_fecha"].toString()),
    empleadoDomicilio: json["empleado_domicilio"],
    empleadoNumero: json["empleado_numero"],
    empleadoOtroNumero: json["empleado_otro_numero"],
    empleadoTipo: json["empleado_tipo"],
    empleadoEstado: json["empleado_estado"],
    what3Words: json["what_3_words"],
    nota: json["nota"],
    pendiente: Parser.toInt(json["pendiente"]),
    aceptadoEmpleado: json["aceptado_empleado"],
  ...
  Map<String, dynamic> toJson() => {
    ...
    "empleado_otro_numero": empleadoOtroNumero,
